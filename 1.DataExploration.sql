...
In this process few Skills are used:
Joins, CTE's, Temp Tables, Windows Functions, Aggregate Functions, Creating Views, Converting Data Types
*/

Select *
From PFPCD..CovidDeaths
 
Select *
From PFPCD..CovidVaccinations;


-- Selecting Data that are needed
...
-- Shows death percentage our country
/*
...
Select Location, MIN(convert(int, total_deaths)) as TotalDeathCount
From PFPCD..CovidDeaths
--Where location like 'India'
Where continent is not null 
Group by Location
...
Select continent, MIN(convert(int,Total_deaths)) as TotalDeathCount
From PFPCD..CovidDeaths
--Where location like 'India'
Where continent is not null 
Group by continent
...
From PFPCD..CovidDeaths dea
Join PFPCD..CovidVaccinations vac
